...
public interface UEnchantments {
     ...
     */
    Enchantment PADDED = register("padded", new SimpleEnchantment(Rarity.COMMON, EnchantmentTarget.ARMOR, false, 0, EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET));

    /**
     * Heavy players move more slowly but are less likely to be flung around wildly.
     */
    Enchantment HEAVY = register("heavy", new AttributedEnchantment(Rarity.COMMON, EnchantmentTarget.ARMOR_FEET, false, 0, EquipmentSlot.FEET))
     ...
     * Alters gravity
     */
    Enchantment REPULSION = register("repulsion", new AttributedEnchantment(Rarity.COMMON, false, 0, EquipmentSlot.FEET))
...
//    Enchantment STRESSED = register("stressed", new StressfulEnchantment());
     ...
     */
    Enchantment CLINGY = register("clingy", new SimpleEnchantment(Rarity.VERY_RARE, true, 0, EquipmentSlot.values()));
